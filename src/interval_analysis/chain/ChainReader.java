 ...
 */
public class ChainReader extends AbstractReader<RMChain> {
    public static final String PARAMETER_MODEL_FILE = "chain_file";

    public ChainReader(OperatorDescription od) {
    ...
    public RMChain read() throws OperatorException {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ChainReader.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
